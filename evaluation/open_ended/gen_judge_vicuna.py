...
save_path = "./data/vicuna/model_judgment/{judger}_{exp_name}.json".format(
    judger=args.judger, exp_name=args.model_answer
)

# ============= Load the model =============
if args.model_name_or_path != "":
    save_path = f"./data/vicuna/model_judgment/{args.model_name_or_path}_{args.model_answer}.json"
    device = "cuda"
...
for output in model_outputs:
    ...
    current_prompt = template.format(
        question=output["instruction"], answer=output["output"]
    )
