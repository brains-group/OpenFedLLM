...
training_args = get_kto_training_args(script_args, script_args.learning_rate)
save_config(script_args, fed_args)
print(script_args, fed_args)

# ===== Load the dataset =====
dataset = get_dataset(script_args.dataset_name, script_args.local_data_dir)
dataset = process_kto_dataset(script_args.dataset_name, dataset, script_args.template, script_args.dataset_sample)
...
if script_args.use_peft == True:
    ...
    # e.g. KTO need a reference model to compute the discrepancy loss
...
for round in tqdm(range(fed_args.num_rounds)):
    ...
    for client in range(fed_args.num_clients):
        ...
        training_args = get_kto_training_args(script_args, new_lr)
