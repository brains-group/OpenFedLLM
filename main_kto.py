...
dataset = process_kto_dataset(
    script_args.dataset_name, dataset, script_args.template, script_args.dataset_sample
)

# ===== Training Arguments =====
training_args = get_kto_training_args(script_args, script_args.learning_rate, dataset)
